        ...
        >
            <div className="container">
                <div className="row d-flex">
                    <div className="row order-first justify-content-center wow fadeInUp mb-30">
                    ...
                    <div className="col-md-12 col-lg-5 pt-50">
                    ...
                    <div className="col-md-5 col-lg-5 order-md-first order-lg-last order-first">
