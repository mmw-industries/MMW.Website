...
const data = {
    breadCrumb: "Startseite / Produkte / Verpackungsdichtheitsprüfer LEAK-MASTER® MAPMAX",
    productTitle: "Verpackungsdichtheitsprüfer LEAK-MASTER® MAPMAX",
    overviewHeader: "Inline-Dichtheitsprüfung für Verpackungen auf CO2-Basis",
    overviewContent: [
        {
            type: 'list',
            header: "",
    ...
    informationHeader: "Inline-System zur Verpackungsdichtheitsprüfung  auf CO2-Basis. Der LEAK-MASTER® MAPMAX ermöglicht zerstörungsfreies Aufspüren selbst kleinster Leckagen ohne den kostspieligen Einsatz von Helium als Spurengas – unmittelbar im Anschluss an den Verpackungsprozess.",
    informationContent: [
